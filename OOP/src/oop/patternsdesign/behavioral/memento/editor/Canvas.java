...
import oop.patternsdesign.behavioral.memento.originators.ColorCommand;
import oop.patternsdesign.behavioral.memento.originators.MoveCommand;
...
public class Canvas extends java.awt.Canvas {
	...
	private void attacheMouseListeners() {
		MouseAdapter colorizer = new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if(target != null) {
					editor.excute(new ColorCommand(editor, new Color((int)(Math.random() * 0x1000000))));
					repaint();
				}
			}
		};
